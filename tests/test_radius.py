...
class RadiusTest(BaseTest):
    ...
    def test_no_neighbors(self):
        ...
        arms, mab = self.predict(arms=[1, 2, 3, 4],
                                 ...
                                 learning_policy=LearningPolicy.EpsilonGreedy(epsilon=0.0),
                                 neighborhood_policy=NeighborhoodPolicy.Radius(radius=0.1),
    ...
    def test_greedy0_no_nhood_predict_random(self):
        ...
        arms, mab = self.predict(arms=[1, 2, 3],
                                 ...
                                 learning_policy=LearningPolicy.EpsilonGreedy(epsilon=0.0),
                                 neighborhood_policy=NeighborhoodPolicy.Radius(radius=0.00001),
    ...
    def test_greedy0_no_nhood_predict_weighted(self):
        ...
        arms, mab = self.predict(arms=[1, 2, 3],
                                 ...
                                 learning_policy=LearningPolicy.EpsilonGreedy(epsilon=0.0),
                                 neighborhood_policy=NeighborhoodPolicy.Radius(radius=0.00001,
                                                                               no_nhood_prob_of_arm=[0.0, 0.8, 0.2]),
                                 context_history=[[1, 1, 2, 3, 5], [1, 2, 1, 1, 1], [0, 0, 1, 0, 0],
                                                  [0, 2, 2, 3, 5], [1, 3, 1, 1, 1], [0, 0, 0, 0, 0]],
                                 contexts=[[0, 1, 2, 3, 5], [1, 1, 1, 1, 1]],
                                 seed=45676,
    ...
    def test_warm_start(self):
        ...
        # After warm start
        self.assertDictEqual(exps[0], {1: 0.0, 2: 0.0, 3: 0.5, 4: 0.0})
        self.assertDictEqual(exps[1], {1: 1.0, 2: 0.0, 3: 1.0, 4: 1.0})
