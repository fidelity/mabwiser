...
def main():
    ...
    # Arm to features
    arm_to_features = {"1": [0.0, 0.0, 1.0], "2": [1.0, 1.0, 0.0], "3": [1.0, 1.0, 0.0]}
    ...
    additional_revenues = [0.0, 12.0, 7.0, 19.0]
    ...
    # Warm start new arm
    greedy.warm_start(WarmStartConfig(arm_to_features=arm_to_features, distance_quantile=0.5))
    ...
    popularity = MAB(MABConfig(
        arms=options,
        learning_policy=Popularity(),
        seed=123456
    ))
