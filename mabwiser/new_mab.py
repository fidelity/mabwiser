...
from mabwiser.utilities.validators import validate_2d, check_true, check_false, check_fit_input, check_in_arms
...
class NewMAB:
    def __init__(self, config: MABConfig):
        ...
        if self._config.neighborhood_policy is not None:
            ...
            # If the learning policy is any of the linear implementations (Greedy, TS, or UCB) then set imp to lp
